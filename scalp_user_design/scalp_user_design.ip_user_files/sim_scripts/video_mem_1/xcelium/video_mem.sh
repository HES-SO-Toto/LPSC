...
#
# Script generated by Vivado on Tue May 21 19:38:22 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : video_mem.sh
...
#
# Usage        : video_mem.sh
#                video_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                video_mem.sh [-reset_run]
#                video_mem.sh [-reset_log]
#                video_mem.sh [-help]
#
...
#                script (type 'video_mem.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname blk_mem_gen_v8_4_7 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm blk_mem_gen_v8_4_7 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "video_mem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./video_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.video_mem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.video_mem -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log video_mem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./video_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: video_mem.sh [-help]\n\
Usage: video_mem.sh [-step]\n\
Usage: video_mem.sh [-lib_map_path]\n\
Usage: video_mem.sh [-reset_run]\n\
Usage: video_mem.sh [-reset_log]\n\
Usage: video_mem.sh [-keep_index]\n\
Usage: video_mem.sh [-noclean_files]\n\n\
