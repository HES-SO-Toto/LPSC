...
#
# Script generated by Vivado on Tue May 14 18:16:01 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pll_mandel.sh
...
#
# Usage        : pll_mandel.sh
#                pll_mandel.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_mandel.sh [-reset_run]
#                pll_mandel.sh [-reset_log]
#                pll_mandel.sh [-help]
#
...
#                script (type 'pll_mandel.sh -help' for more information).
#
...
# script info
echo -e "pll_mandel.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_mandel.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"D:/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pll_mandel xil_defaultlib.glbl -o pll_mandel_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pll_mandel_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pll_mandel_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pll_mandel_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pll_mandel.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pll_mandel.sh [-help]\n\
Usage: pll_mandel.sh [-step]\n\
Usage: pll_mandel.sh [-lib_map_path]\n\
Usage: pll_mandel.sh [-reset_run]\n\
Usage: pll_mandel.sh [-reset_log]\n\
Usage: pll_mandel.sh [-keep_index]\n\
Usage: pll_mandel.sh [-noclean_files]\n\n\
